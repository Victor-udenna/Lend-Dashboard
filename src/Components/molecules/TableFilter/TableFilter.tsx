  ...
  return (
    <div className="filter">
      ...
      <div className="filter__input-container">
        ...
        <Input id="username" type="text" className="filter__input" />
      </div>
      <div className="filter__input-container">
        <label htmlFor="email" className="filter__label">
          Email
        </label>
        <Input id="email" type="email" className="filter__input" />
      </div>
      <div className="filter__input-container">
      ...
      <div className="filter__input-container">
        ...
        <Input id="phone-number" type="tel" className="filter__input" />
      </div>
      <div className="filter__input-container">
